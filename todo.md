...
## Feature - Multi-Dealer Website Scraper Support
- [x] Analyze Maple Ridge Chrysler website HTML structure (geo-blocked from US)
- [ ] Note: Scraper won't work for geo-blocked sites, use CSV import instead

## Feature - CSV Import for Inventory
- [x] Design CSV format (columns: stockNumber, year, make, model, trim, price, mileage, vin, category, location, imageUrl, description)
- [x] Create backend tRPC procedure to parse and validate CSV
